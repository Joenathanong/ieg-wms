...
import { Users, Save, Plus, Trash2, RefreshCw, KeyRound, Lock, Unlock } from 'lucide-react';
...
const emptyForm = { id: '', username: '', full_name: '', password: '', role: 'OPERATOR' as Row['role'], is_active: true };
...
export default function Su01Page() {
  ...
  const cols: Column<Row>[] = [
    ...
    { key: 'last_login', header: 'Last Logon', mono: true, width: '160px', render: (r) => fmtDateTime(r.last_login) || '—' },
